...
Args:- list_dictionaries: list of dicts
Returns: JSON representation of the list"""
                if list_dictionaries is None or list_dictionaries == []:
                    return "[]"
                if (type(list_dictionaries) != list or
                    not all(type(x) == dict for x in list_dictionaries)):
                    raise TypeError("list_dictionaries must
...
list_objs to a file.Args:- list_objs: list of instances who inherits of Base"""
                """
...
raise TypeError("list_objs must be a list of instances")"""
                if list_objs is None or list_objs == []:
                    ...
                    jstr = cls.to_json_string([o.to_dictionary()
                                               for o in list_objs])
...
Args:- json_string: string to convert to list"""
                            l = []
                            if json_string is not None
                            and json_string != '':
                                if type(json_string) != str:
                                    raise TypeError("json_string must
be a string")
...
Args:- dictionary: used as **kwargs
...
- list_objs: list of instances"""
                                                if (type(list_objs) != list and
                                                    ...
                                                    not all(isinstance(x, cls)
                                                            for x in list_objs)):
                                                    raise TypeError("list_objs must be a
list of instances")
                                                filename = cls.__name__ + ".csv"
                                                with open(filename, 'w') as f:
                                                    if list_objs is not None:
                                                        list_objs = [x.to_dictionary()
                                                                     for x in list_objs]
                                                        if cls.__name__ ==
                                                        'Rectangle':
...
Args:- list_rectangles: list of Rectangle instances
